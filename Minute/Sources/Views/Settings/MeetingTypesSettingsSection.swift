    ...
    var body: some View {
        Group {
            FieldBlock(
                ...
                SettingsMeetingTypeWrapLayout(horizontalSpacing: 8, verticalSpacing: 8) {
                    ForEach(model.meetingTypes, id: \.typeId) { definition in
                        SettingsMeetingTypeChip(
...
private struct SettingsMeetingTypeChip: View {
    let title: String
...
private struct SettingsMeetingTypeWrapLayout: Layout {
